import datetime
import Finances.comdirect_api.utils
...
TransactionType = {
    ...
    "BANK_FEES": "Bank Fees",  # TODO was missing
...
class Document():
    ...
    def get_filename(self):
        ...
        if self.mimeType == "text/html":
            ...
            fileEnding = ".pdf"
        return str(self.dateCreation) + "_" + Finances.comdirect_api.utils.make_printable(self.name) + fileEnding